    ...
    >
      <div class="container">
        <div class="row m0 center-xs between-md">
          ...
          <div class="row social mt30" v-if="$store.state.config.socialNetworks">
            <a
              v-if="$store.state.config.socialNetworks.facebook"
              class="social-icon mx10 brdr-circle no-underline"
              :href="$store.state.config.socialNetworks.facebook"
            ...
            <a
              v-if="$store.state.config.socialNetworks.instagram"
              class="social-icon mx10 brdr-circle no-underline"
              :href="$store.state.config.socialNetworks.instagram"
            ...
            <a
              v-if="$store.state.config.socialNetworks.pinterest"
              class="social-icon mx10 brdr-circle no-underline"
              :href="$store.state.config.socialNetworks.pinterest"
            ...
            <a
              v-if="$store.state.config.socialNetworks.youtube"
              class="social-icon mx10 brdr-circle no-underline"
              :href="$store.state.config.socialNetworks.youtube"
